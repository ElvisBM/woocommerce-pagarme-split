...
class WC_Pagarme_Fields_User{
	...
	public function add_fields_wc_vendor( ){
		...
		$theme .= '<label for="legal_name">Nome Completo</label>';
		$theme .= ' <span class="description"> - Por favor preencha o nome completo</span><br >';
		...
		$theme .= '<label for="document_number">CPF ou CNPJ</label>';
		$theme .= ' <span class="description"> - Por favor preencha com o CPF ou CNPJ do responsável pelo o recebimento</span><br >';
		...
		$theme .= '<label for="bank_code">Banco</label>';
		$theme .= ' <span class="description">- Por favor escolha o Banco de sua conta</span><br >';
		...
		$theme .= '<label for="type">Conta</label>';
		$theme .= ' <span class="description"> - Por favor escolha o tipo de conta</span><br >';
		...
		$theme .='<select name="type" id="type"><option value="">Escolha o tipo de conta</option>';
		$theme .= $list_conta;
		$theme .='</select>';
		$theme .= '</div>';
		...
		$theme .= '<label for="agencia">Agência</label>';
		$theme .= ' <span class="description"> - Por favor preencha Agência</span><br >';
		$theme .= '<input type="text" name="agencia" id="agencia" value="'.get_user_meta( get_current_user_id(), 'agencia', true ).'" class="regular-text" />';
		$theme .= '</div>';
		$theme .= '<div class="all-50 tiny-100" >';
		$theme .= '<label for="agencia_dv">Digito da Agência</label>';
		$theme .= ' <span class="description"> - Por favor preencha digito da Agência</span><br >';
		...
		$theme .= '<div class="all-50 tiny-100" >';
		$theme .= '<label for="conta">Conta</label>';
		$theme .= ' <span class="description"> - Por favor preencha os dados conta para recebimento</span><br >';
		$theme .= '<input type="text" name="conta" id="conta" value="'.get_user_meta( get_current_user_id(), 'conta', true ).'" class="regular-text" />';
		$theme .= '</div>';
		$theme .= '<div class="all-50 tiny-100" >';
		$theme .= '<label for="conta_dv">Digito da Conta</label>';
		$theme .= ' <span class="description"> - Por favor preencha digito da Conta</span><br >';
		...
		$theme .= '<label for="transfer_interval">Frequência que gostaria de receber</label>';
		$theme .= ' <span class="description"> - Escolha quando gostaria de receber</span><br >';
		...
		$theme .= '<label for="transfer_day">Escolha o dia da semana que será transferido</label>';
		$theme .= ' <span class="description"> - Escolha quando gostaria de receber</span><br >';
		...
		$theme .= '<label for="transfer_interval">Digite o dia do mês que gostaria de ser pago de 1 a 31</label>';
		$theme .= ' <span class="description"> - Escolha quando gostaria de receber</span><br >';
